# Generated by Django 4.0.4 on 2022-06-02 03:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='GameNewsApp.portaluser')),
            ],
        ),
        migrations.CreateModel(
            name='PostCategory',
        ...
        migrations.AddField(
            model_name='category',
            name='subsribers',
            field=models.ManyToManyField(through='GameNewsApp.UserCategory', to='GameNewsApp.portaluser'),
        ),
        migrations.AddField(
            model_name='author',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='GameNewsApp.portaluser'),
        ),
    ]
